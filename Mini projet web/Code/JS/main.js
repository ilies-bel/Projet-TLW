			...
			function buildDestination() {
				...
				for (const v of dest) {// itère sur le tableau
					...
					function fctTransfert(x) {
						...
						switch (id) {
							case "A1":
								window.location.href = "Reservation.html" + "?destination=valeur1";
								break;
							case "A2":
								window.location.href = "Reservation.html" + "?destination=valeur2";
								break;
							case "A3":
								window.location.href = "Reservation.html" + "?destination=valeur3";
								break;
							case "A4":
								window.location.href = "Reservation.html" + "?destination=valeur4";
								break;
							case "A5":
								window.location.href = "Reservation.html" + "?destination=valeur5";
								break;
							case "A6":
								window.location.href = "Reservation.html" + "?destination=valeur6";
								break;
							default:
								break;
						}
					...
					//--------------------------------------------------------------------------- Fonction  récapitulatif de la reservation
